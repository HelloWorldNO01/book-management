...
export const categories = [
  { id: 1, name: '文学', sortOrder: 2, status: 'enabled' },
  { id: 2, name: '教材', sortOrder: 4, status: 'enabled' },
  { id: 3, name: '技术', sortOrder: 1, status: 'enabled' },
  { id: 4, name: '历史', sortOrder: 3, status: 'disabled' }
]
